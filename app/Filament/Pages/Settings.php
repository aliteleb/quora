    ...
    private function getThemeSchema(): array
    {
        return [
            Section::make([
                ...
                ColorPicker::make('theme-select-space-border-color')->label('لون حواف اختيار المساحة عند انشاء سؤال او نشر بوست')->hiddenLabel()->placeholder('لون حواف اختيار المساحة عند انشاء سؤال او نشر بوست'),
                ColorPicker::make('theme-unread_notification_bg')->label('لون الإشعارات الغير مقروءة')->hiddenLabel()->placeholder('لون الإشعارات الغير مقروءة'),
