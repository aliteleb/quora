    ...
    return (
        ...
        >
            <div
                ...
                className={`z-50 dropdown-clip-path-responsive 2xl:createDropdown-clip-path absolute left-1/2 top-11 2xl:-translate-x-1/2 border border-[--theme-default-border-color] rounded bg-[--theme-main-bg-color] pt-3`}
            >
                <TransitionChild
