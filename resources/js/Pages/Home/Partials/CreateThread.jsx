        ...
        <div className={`z-10 bg-[--theme-main-bg-color] w-full text-[--theme-primary-text-color] h-fit p-5 rounded flex flex-col gap-y-5`}>
                ...
                <div className={`grid grid-cols-3`}>
                    <div onClick={() => {
                        ...
                        <div className={`w-full flex items-center gap-x-3 font-bold justify-center hover:bg-[--theme-main-bg-color-hover] py-2 rounded`}>
                            <CiSquareQuestion/>
                            <span>اسأل</span>
                        </div>
                        <div className={`w-[1px] h-5 ms-2 bg-[--theme-main-bg-color-hover]`}></div>
                    </div>

                    <div className={`cursor-pointer flex items-center`}>
                        <div className={`ms-2 w-full flex items-center gap-x-3 font-bold justify-center hover:bg-[--theme-main-bg-color-hover] py-2 rounded`}>
                            <LuFileEdit />
                            أجب
                        </div>
                        <div className={`w-[1px] h-5 ms-2 bg-[--theme-main-bg-color-hover]`}></div>
                    ...
                    }} className={`cursor-pointer ms-2 flex items-center gap-x-3 font-bold justify-center hover:bg-[--theme-main-bg-color-hover] py-2 rounded`}>
                        <IoPencil />
                        نشر
                    </div>
                </div>
